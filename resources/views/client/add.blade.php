                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-9 col-9">
                                                            <input type="text" class="form-control" name="cin" placeholder="رقم البطاقة البطاقة">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-9 col-9">
                                                            <input type="text" class="form-control" name="name" placeholder="اسم المشرك ">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row align-items-center">
                                                        ...
                                                        <div class="col-lg-9 col-9">
                                                            <input type="text"  class="form-control" name="subscription_fees" placeholder="ثمن الاشتراك">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
